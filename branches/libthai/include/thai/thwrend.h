...
extern void th_wcrender_cell_tis(struct thcell cell,
                                 thwchar_t *res, size_t res_sz);
extern void th_wcrender_cell_win(struct thcell cell,
                                 thwchar_t *res, size_t res_sz);
extern void th_wcrender_cell_mac(struct thcell cell,
                                 thwchar_t *res, size_t res_sz);

extern int th_wcrender_text_tis(const thwchar_t *s, thwchar_t *res, size_t res_sz);
extern int th_wcrender_text_win(const thwchar_t *s, thwchar_t *res, size_t res_sz);
extern int th_wcrender_text_mac(const thwchar_t *s, thwchar_t *res, size_t res_sz);
